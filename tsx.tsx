...
export const React = {
    createElement: function (tag:string, attrs:any, children:any) {
        var element;
...
*/
export function jsxRegister(el:HTMLElement){
    callbacks.push(el);
}
...
let callbacks:any = []
function callback(){
        callbacks = callbacks.filter(function(value:any, index:any, arr:any){
